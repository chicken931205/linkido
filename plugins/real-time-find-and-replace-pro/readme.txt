...
A [pro version](http://infolific.com/technology/software-worth-using/real-time-find-and-replace-for-wordpress/#pro-version) with additional filtering options and export/import functionality. For those that have previously donated, the pro version is available for free. Let me know if you're interested.
...
= 4.0.3 =
* Pro Version: Replaced deprecated PHP function.

= 4.0.2 =
* All Versions: Added nonce security check to rules form.

= 4.0.1 =
* Pro Version: Minor change to address false alert from WordFence.
...
= 3.5 =
* Testing some back-end functionality and needed to force a version number change.

= 3.4 =
* All versions: Additional security to prevent direct access of plugin file.
* Pro version: Added licensing and update notification functionality.
