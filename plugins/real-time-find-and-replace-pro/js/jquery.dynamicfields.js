	...
	jQuery("#far_itemlist").append(
		...
		"<li id ='row" + id + "'>" +
			...
			"<div style='float: left;'>" +
				...
				"<input class='textbox' type='text' name='farquerystring[" + id + "]' id='farquerystring" + id +"' />" +
				"<br />" +

				"<label class='side-label' for='farreferral" + id + "'>Referrer:</label>" +
				"<input class='textbox' type='text' name='farreferrer[" + id + "]' id='farreferrer" + id +"' />" +
				"<br />" +

				"<label class='side-label' for='faruseragent" + id + "'>User Agent:</label>" +
				"<input class='textbox' type='text' name='faruseragent[" + id + "]' id='faruseragent" + id +"' />" +
				"<br />" +

			"</div>" +

			"<div>" +
				"<input style='width: 615px;' type='text' name='fardescription[" + id + "]' id='fardescription" + id + "' />" +
