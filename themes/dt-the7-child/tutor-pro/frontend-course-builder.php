												...
												<label class="tutor-amount-field">
													<div class="tutor-input-group">
														...
														<?php 
															...
															// }
														?>
														<input type="number" class="tutor-form-number-verify tutor-form-control test" name="course_sale_price" value="<?php echo $course_price->sale_price; //echo get_tutor_option('earning_instructor_commission');  ?>" placeholder="<?php _e( 'Set course sale price', 'tutor-pro' ); ?>" step="any" min="0" pattern="^\d*(\.\d{0,2})?$">
													</div>
												</label>
											</div>
										</div>
